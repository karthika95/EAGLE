...
class SamdConfig:
    ...
    len_threshold: int = field(default=3)   # Minimum length to consider for SAM decoding, else use EAGLE
    len_bias: int = field(default=2)    # Static SAM should generate len_bias more tokens than Dyn SAM to get considered
